      ...
      public void run() {
        try {
          if (watsonAssistantSession == null) {
            ServiceCall<SessionResponse> call = watsonAssistant.createSession(new CreateSessionOptions.Builder().assistantId(mContext.getString(R.string.ass_id)).build());
...
//                System.out.println(message.getSid());
                ...
                smsManager.sendTextMessage("3234493775", null, "Hey! I am at risk. Help me. I was last at 475 Via Ortega, Stanford, CA 94305 ", null, null);
            }
          }
        } catch (Exception e) {
          e.printStackTrace();
